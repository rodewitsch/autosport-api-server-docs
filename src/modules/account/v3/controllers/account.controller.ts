...
import {
  GetUpdatedAccountInformationQueryDtoV3,
  UpdatedAccountInformationResponseDtoV3,
} from '../dto/get-updated-account-info';
import { SaveDeviceTokenDtoV3 } from '../dto/save-device-token.dto';
import { UpdateAccountBodyDtoV3, UpdateAccountResponseDtoV3 } from '../dto/update-account.dto';
...
export class AccountControllerV3 {
  constructor() {}
  ...
  @Auth([AppRole.USER])
  @ApiResponses({
    200: UpdateAccountResponseDtoV3,
  ...
  async updateAccount(
    ...
    @Headers() headers: any,
    @Body() body: UpdateAccountBodyDtoV3,
  ) {}
  ...
  @ApiResponse({
    status: 200,
    description: 'Account photo, jpeg',
  })
  @ApiResponses({
    400: CommonMessageResponseDto,
    500: CommonMessageResponseDto,
  ...
  @Auth([AppRole.USER])
  @ApiResponses({
    200: UpdatedAccountInformationResponseDtoV3,
    400: CommonMessageResponseDto,
    500: CommonMessageResponseDto,
  })
  async getUpdatedAccountInformation(
    @Session() profileData: ProfileData,
    @Param('account_id') account_id: string,
    @Query() query: GetUpdatedAccountInformationQueryDtoV3,
  ) {}
  ...
  async saveDeviceToken(
    ...
    @Body() body: SaveDeviceTokenDtoV3,
    @Headers() headers: any,
  ) {}
}
