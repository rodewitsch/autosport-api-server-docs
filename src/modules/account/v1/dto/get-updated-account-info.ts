...
export class GetUpdatedAccountInformationQueryDtoV1 {
  @ApiProperty({
...
@Exclude()
export class UpdatedAccountInformationResponseDtoV1 {
  @Expose()
  @ApiPropertyOptional({
  ...
  constructor(partial: Partial<UpdatedAccountInformationResponseDtoV1>) {
