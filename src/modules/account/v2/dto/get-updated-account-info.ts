...
export class GetUpdatedAccountInformationQueryDtoV2 {
  @ApiProperty({
...
@Exclude()
export class UpdatedAccountInformationResponseDtoV2 {
  @Expose()
  @ApiPropertyOptional({
  ...
  constructor(partial: Partial<UpdatedAccountInformationResponseDtoV2>) {
