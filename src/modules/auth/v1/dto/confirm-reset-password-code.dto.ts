...
export class ConfirmResetPasswordCodeBodyDtoV1 {
  @ApiProperty({
...
export class ConfirmResetPasswordCodeResponseDtoV1 {
  @ApiProperty({
  ...
  constructor(data: ConfirmResetPasswordCodeResponseDtoV1) {
