...
export class ConfirmResetPasswordCodeBodyDtoV3 {
  @ApiProperty({
...
export class ConfirmResetPasswordCodeResponseDtoV3 {
  @ApiProperty({
  ...
  constructor(data: ConfirmResetPasswordCodeResponseDtoV3) {
