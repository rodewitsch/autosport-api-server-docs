...
@Exclude()
export class GetTimeAttackChampionshipEventRatingRecordsResponseDtoV1 {
  @Expose()
  @ApiProperty({
  ...
  constructor(partial: Partial<GetTimeAttackChampionshipEventRatingRecordsResponseDtoV1>) {
    Object.assign(this, partial);
  }
}

@Exclude()
export class GetTimeAttackChampionshipEventRatingResponseDtoV1 {
  ...
  @ApiProperty({
    ...
    type: [GetTimeAttackChampionshipEventRatingRecordsResponseDtoV1],
  })
  @Type(() => GetTimeAttackChampionshipEventRatingRecordsResponseDtoV1)
  records: GetTimeAttackChampionshipEventRatingRecordsResponseDtoV1[];

  constructor(partial: Partial<GetTimeAttackChampionshipEventRatingResponseDtoV1>) {
    Object.assign(this, partial);
  }
}
