...
import { GetEventMemberResponseDtoV2 } from './get-event-members.dto';
...
@Exclude()
export class AddEventMemberResponseDtoV2 extends GetEventMemberResponseDtoV2 {
  @Expose()
  @ApiProperty({
  ...
  constructor(partial: Partial<AddEventMemberResponseDtoV2>) {
    super(partial);
