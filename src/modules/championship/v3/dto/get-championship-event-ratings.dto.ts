...
@Exclude()
export class GetTimeAttackChampionshipEventRatingRecordsResponseDtoV3 {
  @Expose()
  @ApiProperty({
  ...
  constructor(partial: Partial<GetTimeAttackChampionshipEventRatingRecordsResponseDtoV3>) {
    Object.assign(this, partial);
  }
}

@Exclude()
export class GetTimeAttackChampionshipEventRatingResponseDtoV3 {
  ...
  @ApiProperty({
    ...
    type: [GetTimeAttackChampionshipEventRatingRecordsResponseDtoV3],
  })
  @Type(() => GetTimeAttackChampionshipEventRatingRecordsResponseDtoV3)
  records: GetTimeAttackChampionshipEventRatingRecordsResponseDtoV3[];

  constructor(partial: Partial<GetTimeAttackChampionshipEventRatingResponseDtoV3>) {
    Object.assign(this, partial);
  }
}
