...
export class GetLocationsQueryDtoV3 {
  @ApiPropertyOptional({
...
@Exclude()
export class GetLocationsResponseDtoV3 {
  @Expose()
  @ApiProperty({
  ...
  @Transform(({ obj }) => (obj.photo ? `/api/v3/locations/${obj.location_id}/photo?d=${obj.updated_at}` : null))
  photo_url: Buffer;
  ...
  constructor(partial: Partial<GetLocationsResponseDtoV3>) {
    Object.assign(this, partial);
  }
}
