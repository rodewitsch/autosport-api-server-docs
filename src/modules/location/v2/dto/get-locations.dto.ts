...
export class GetLocationsQueryDtoV2 {
  @ApiPropertyOptional({
...
@Exclude()
export class GetLocationsResponseDtoV2 {
  @Expose()
  @ApiProperty({
  ...
  @Transform(({ obj }) => (obj.photo ? `/api/v2/locations/${obj.location_id}/photo?d=${obj.updated_at}` : null))
  photo_url: Buffer;
  ...
  constructor(partial: Partial<GetLocationsResponseDtoV2>) {
    Object.assign(this, partial);
  }
}
