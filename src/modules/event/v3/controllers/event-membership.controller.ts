...
import { AddEventMemberDtoV3, OwnEventMemberResponseDtoV3 } from '../dto/add-event-member.dto';
import { CheckInBodyDtoV3 } from '../dto/check-in.dto';
import {
  ChangeEventMemberDistributionBodyDtoV3,
  GetEventMemberDistributionResponseDtoV3,
  GetEventMembersForDistributionQueryDtoV3,
  GetGroupedEventMemberDistributionResponseDtoV3,
} from '../dto/event-members-distribution.dto';
import { GetEventMemberResponseDtoV3 } from '../dto/get-event-members.dto';
...
export class EventMembershipControllerV3 {
  constructor() {}
  ...
  @ApiResponses({
    200: [GetEventMemberResponseDtoV3],
    400: CommonMessageResponseDto,
    500: CommonMessageResponseDto,
  })
  async getEventMembers(@Param('event_id') event_id: string) {}

  @Get('/:event_id/members/:driver_id/info')
  @Auth([AppRole.GUEST])
  @ApiOperation({ summary: 'Get event member info' })
  @ApiResponses({
    200: GetEventMemberResponseDtoV3,
    400: CommonMessageResponseDto,
    500: CommonMessageResponseDto,
  })
  async getEventMemberInfo(@Param('event_id') event_id: string, @Param('driver_id') driver_id: string) {}
    ...
    content: {
      'application/json': {
        ...
        schema: {
          oneOf: [
            {
              $ref: '#/components/schemas/GetEventMemberDistributionResponseDtoV3',
              description: 'Ungrouped list',
            },
            {
              $ref: '#/components/schemas/GetGroupedEventMemberDistributionResponseDtoV3',
  ...
  @ApiExtraModels(GetGroupedEventMemberDistributionResponseDtoV3, GetEventMemberDistributionResponseDtoV3)
  async getEventMembersForDistribution(
    @Param('event_id') event_id: string,
    @Query() query: GetEventMembersForDistributionQueryDtoV3,
  ) {}
  ...
  @ApiResponses({
    200: GetEventMemberDistributionResponseDtoV3,
    400: CommonMessageResponseDto,
    500: CommonMessageResponseDto,
  })
  async changeEventMemberDistribution(
    ...
    @Body() body: ChangeEventMemberDistributionBodyDtoV3,
  ) {}
  ...
  @ApiResponses({
    200: OwnEventMemberResponseDtoV3,
    400: CommonMessageResponseDto,
