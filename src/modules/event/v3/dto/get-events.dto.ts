...
import { Coordinates } from '../../../location/v3/dto/get-locations.dto';
import { EventType } from '../enums/event-type.enum';

export class GetEventQueryDtoV3 {
...
export class GetEventsQueryDtoV3 extends PartialType(LimitOffsetQueryDto) {
  event_id?: number;
...
@Exclude()
export class RequiredDocumentsResponseDtoV3 {
  @Expose()
  @ApiProperty({
  ...
  constructor(partial: Partial<RequiredDocumentsResponseDtoV3>) {
    Object.assign(this, partial);
  }
}

@Exclude()
export class WeatherConditionResponseDtoV3 {
  @Expose()
  @ApiProperty({
  ...
  constructor(partial: Partial<WeatherConditionResponseDtoV3>) {
    Object.assign(this, partial);
  }
}

@Exclude()
export class EventWeatherResponseDtoV3 {
  @ApiProperty({
  ...
  @ApiProperty({
    ...
    type: WeatherConditionResponseDtoV3,
  })
  @Transform(({ value }) => value && new WeatherConditionResponseDtoV3(value[0]))
  @Type(() => WeatherConditionResponseDtoV3)
  weather: WeatherConditionResponseDtoV3;
  ...
  constructor(partial: Partial<EventWeatherResponseDtoV3>) {
    Object.assign(this, partial);
  }
}

@Exclude()
export class EventRegistrationInfoResponseDtoV3 {
  @Expose()
  @ApiProperty({
  ...
  constructor(partial: Partial<EventRegistrationInfoResponseDtoV3>) {
    Object.assign(this, partial);
  }
}

@Exclude()
export class GetEventResponseDtoV3 {
  @Expose()
  @ApiProperty({
  ...
  @Transform(({ obj }) => (obj.image ? `/api/v3/events/${obj.event_id}/image?d=${obj.updated_at}` : null))
  image_url: Buffer;
  ...
  @ApiProperty({
    ...
    type: [RequiredDocumentsResponseDtoV3],
  })
  @Type(() => RequiredDocumentsResponseDtoV3)
  @Transform(({ value }) => (value ? value.map((document) => new RequiredDocumentsResponseDtoV3(document)) : []))
  required_documents: RequiredDocumentsResponseDtoV3[] = [];
  ...
  @ApiPropertyOptional({
    ...
    type: EventRegistrationInfoResponseDtoV3,
  })
  @Transform(({ value }) => value && new EventRegistrationInfoResponseDtoV3(value))
  registration_info: EventRegistrationInfoResponseDtoV3;

  @Expose()
  @ApiPropertyOptional({
    description: 'Event weather',
    type: EventWeatherResponseDtoV3,
  })
  @Transform(
    ({ obj }) => obj.weather && new EventWeatherResponseDtoV3({ ...obj.weather, c_weather_rl: obj.c_weather_rl }),
  )
  weather?: EventWeatherResponseDtoV3;

  constructor(partial: Partial<GetEventResponseDtoV3>) {
    Object.assign(this, partial);
  }
}
