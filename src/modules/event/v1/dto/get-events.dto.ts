...
import { Coordinates } from '../../../location/v1/dto/get-locations.dto';
import { EventType } from '../enums/event-type.enum';

export class GetEventQueryDtoV1 extends PartialType(LimitOffsetQueryDto) {
  event_id?: number;
...
@Exclude()
export class RequiredDocumentsResponseDtoV1 {
  @Expose()
  @ApiProperty({
  ...
  constructor(partial: Partial<RequiredDocumentsResponseDtoV1>) {
    Object.assign(this, partial);
  }
}

@Exclude()
export class WeatherConditionResponseDtoV1 {
  @Expose()
  @ApiProperty({
  ...
  constructor(partial: Partial<WeatherConditionResponseDtoV1>) {
    Object.assign(this, partial);
  }
}

@Exclude()
export class EventWeatherResponseDtoV1 {
  @ApiProperty({
  ...
  @ApiProperty({
    ...
    type: WeatherConditionResponseDtoV1,
  })
  @Transform(({ value }) => value && new WeatherConditionResponseDtoV1(value[0]))
  @Type(() => WeatherConditionResponseDtoV1)
  weather: WeatherConditionResponseDtoV1;
  ...
  constructor(partial: Partial<EventWeatherResponseDtoV1>) {
    Object.assign(this, partial);
  }
}

@Exclude()
export class EventRegistrationInfoResponseDtoV1 {
  @Expose()
  @ApiProperty({
  ...
  constructor(partial: Partial<EventRegistrationInfoResponseDtoV1>) {
    Object.assign(this, partial);
  }
}

@Exclude()
export class GetEventResponseDtoV1 {
  @Expose()
  @ApiProperty({
  ...
  @Transform(({ obj }) => (obj.image ? `/api/v1/events/${obj.event_id}/image?d=${obj.updated_at}` : null))
  image_url: Buffer;
  ...
  @ApiProperty({
    ...
    type: [RequiredDocumentsResponseDtoV1],
  })
  @Type(() => RequiredDocumentsResponseDtoV1)
  @Transform(({ value }) => (value ? value.map((document) => new RequiredDocumentsResponseDtoV1(document)) : []))
  required_documents: RequiredDocumentsResponseDtoV1[] = [];
  ...
  @ApiPropertyOptional({
    ...
    type: EventRegistrationInfoResponseDtoV1,
  })
  @Transform(({ value }) => value && new EventRegistrationInfoResponseDtoV1(value))
  registration_info: EventRegistrationInfoResponseDtoV1;

  @Expose()
  @ApiPropertyOptional({
    description: 'Event weather',
    type: EventWeatherResponseDtoV1,
  })
  @Transform(
    ({ obj }) => obj.weather && new EventWeatherResponseDtoV1({ ...obj.weather, c_weather_rl: obj.c_weather_rl }),
  )
  weather?: EventWeatherResponseDtoV1;

  constructor(partial: Partial<GetEventResponseDtoV1>) {
    Object.assign(this, partial);
  }
}
