...
export class GetEventMembersForDistributionQueryDtoV2 {
  @ApiPropertyOptional({
...
export class ChangeEventMemberDistributionBodyDtoV2 {
  @ApiPropertyOptional({
...
@Exclude()
export class GetEventMemberDistributionResponseDtoV2 {
  @Expose()
  @ApiProperty({
  ...
  constructor(partial: Partial<GetEventMemberDistributionResponseDtoV2>, lang?: string) {
    Object.assign(this, partial, { i18n: { lang } });
  }
}

@Exclude()
export class GetGroupedEventMemberDistributionResponseDtoV2 {
  @Expose()
  @ApiProperty({
    description: 'Group number (code)',
  })
  ...
  @ApiProperty({
    description: 'Members',
    type: [GetEventMemberDistributionResponseDtoV2],
  })
  @Transform(({ value }) => value.map((member) => new GetEventMemberDistributionResponseDtoV2(member)))
  members: GetEventMemberDistributionResponseDtoV2[];

  constructor(partial: Partial<GetGroupedEventMemberDistributionResponseDtoV2>) {
