...
import { ChangeEventRoadConditionBodyDtoV2 } from '../dto/change-event-road-condition.dto';
import { ChangeEventStatusBodyDtoV2 } from '../dto/change-event-status.dto';
import {
  GetDragResultsResponseDtoV2,
  GetEventResultsQueryDtoV2,
  GetTimeAttackResultsResponseDtoV2,
} from '../dto/get-event-results.dto';
import { GetEventRulesResponseDtoV2 } from '../dto/get-event-rules.dto';
import { GetEventYearsQueryDtoV2 } from '../dto/get-events-years.dto';
import { GetEventQueryDtoV2, GetEventResponseDtoV2, GetEventsQueryDtoV2 } from '../dto/get-events.dto';
import { GetUpdatedEventQueryDtoV2 } from '../dto/get-updated-events.dto';
...
export class EventControllerV2 {
  ...
  @ApiResponses({
    200: Paginate(GetEventResponseDtoV2),
    400: CommonMessageResponseDto,
    500: CommonMessageResponseDto,
  })
  @Auth([AppRole.GUEST])
  async getEvents(@Session() profileData: ProfileData, @Query() query: GetEventsQueryDtoV2) {}

  @Get('/updated')
  @ApiOperation({ summary: 'Get updated events (since some date)' })
  @ApiResponses({
    200: [GetEventResponseDtoV2],
    400: CommonMessageResponseDto,
    500: CommonMessageResponseDto,
  })
  @Auth([AppRole.GUEST])
  async getUpdatedEvents(@Session() profileData: ProfileData, @Query() query: GetUpdatedEventQueryDtoV2) {}

  @Get('/rules/:rules_id')
  @ApiOperation({ summary: 'Get event rules' })
  @ApiResponses({
    200: GetEventRulesResponseDtoV2,
    400: CommonMessageResponseDto,
    500: CommonMessageResponseDto,
  })
  ...
  async getEventsYears(@Query() query: GetEventYearsQueryDtoV2) {}
  ...
  @Auth([AppRole.GUEST])
  async getEvent(@Param('event_id') event_id: string, @Query() query: GetEventQueryDtoV2) {}
  ...
  async changeEventStatus(@Param('event_id') event_id: string, @Body() body: ChangeEventStatusBodyDtoV2) {}
  ...
  async changeEventRoadCondition(
    ...
    @Body() body: ChangeEventRoadConditionBodyDtoV2,
  ) {}
  ...
  @ApiExtraModels(GetTimeAttackResultsResponseDtoV2, GetDragResultsResponseDtoV2)
  async getEventResults(
    @I18n() i18n: I18nContext,
    @Param('event_id') id: string,
    @Query() query: GetEventResultsQueryDtoV2,
  ) {}
}
