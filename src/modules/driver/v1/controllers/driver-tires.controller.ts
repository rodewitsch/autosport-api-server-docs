...
import { AddDriverTiresBodyDtoV1, DriverTiresResponseDtoV1 } from '../dto/driver-tires.dto';
...
export class DriverTiresControllerV1 {
  constructor() {}

  @Post()
  @ApiOperation({ summary: 'Add driver tires' })
  @ApiResponses({
    200: DriverTiresResponseDtoV1,
  ...
  async addDriverTires(
    ...
    @Body() body: AddDriverTiresBodyDtoV1,
  ) {}
