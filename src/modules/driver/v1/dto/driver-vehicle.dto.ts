...
export class AddDriverVehicleBodyDtoV1 {
  @ApiPropertyOptional({
...
export class UpdateDriverVehicleBodyDtoV1 extends AddDriverVehicleBodyDtoV1 {}

@Exclude()
export class DriverVehicleResponseDtoV1 {
  @Expose()
  @ApiProperty({
  ...
  constructor(partial: Partial<DriverVehicleResponseDtoV1>) {
