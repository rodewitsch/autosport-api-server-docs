...
export class GetDriverRatingQueryDtoV1 {
  @ApiPropertyOptional({
...
@Exclude()
export class GetDriverRaceTypeRecordsResponseDtoV1 {
  @Expose()
  @ApiProperty({
  ...
  constructor(partial: Partial<GetDriverRaceTypeRecordsResponseDtoV1>) {
    Object.assign(this, partial);
  }
}

@Exclude()
export class GetDriverRatingResponseDtoV1 {
  @Expose()
  @ApiProperty({
    description: 'Driver ID',
    type: 'number',
  ...
  @Transform(({ obj }) => (obj.photo ? `/api/v1/drivers/${obj.driver_id}/photo?d=${obj.updated_at}` : null))
  photo: boolean;
  ...
  @Transform(({ value }) => new GetDriverRaceTypeRecordsResponseDtoV1(value))
  rating: GetDriverRaceTypeRecordsResponseDtoV1;

  constructor(partial: Partial<GetDriverRatingResponseDtoV1>) {
    Object.assign(this, partial);
  }
}
