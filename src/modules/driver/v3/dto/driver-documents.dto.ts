...
export class GetDriverDocumentsQueryDtoV3 {
  @ApiPropertyOptional({
...
export class DocumentFileBodyDtoV3 {
  @ApiPropertyOptional({
  ...
  constructor(partial: Partial<DocumentFileBodyDtoV3>) {
    Object.assign(this, partial);
  }
}

export class AddDriverDocumentsBodyDtoV3 {
  @ApiProperty({
  ...
  @ApiProperty({
    ...
    type: [DocumentFileBodyDtoV3],
  })
  @Transform(({ value }) => (value ? value.map((file) => new DocumentFileBodyDtoV3(file)) : []))
  @Type(() => DocumentFileBodyDtoV3)
  files: DocumentFileBodyDtoV3[];
}

export class UpdateDriverDocumentsBodyDtoV3 extends AddDriverDocumentsBodyDtoV3 {}

@Exclude()
export class DocumentFileResponseDtoV3 {
  @Expose()
  @ApiPropertyOptional({
  ...
  constructor(partial: Partial<DocumentFileResponseDtoV3>) {
    Object.assign(this, partial);
  }
}
@Exclude()
export class DriverDocumentsResponseDtoV3 {
  @Expose()
  @ApiProperty({
  ...
  @ApiProperty({
    name: 'files',
    description: 'Document files',
    type: [DocumentFileResponseDtoV3],
  })
  @Type(() => DocumentFileResponseDtoV3)
  @Transform(({ value }) => value && value.map((file) => new DocumentFileResponseDtoV3(file)))
  document_files: DocumentFileResponseDtoV3[] = [];

  constructor(partial: Partial<DriverDocumentsResponseDtoV3>) {
    Object.assign(this, partial);
  }
}
