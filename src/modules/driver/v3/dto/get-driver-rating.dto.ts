...
export class GetDriverRatingQueryDtoV3 {
  @ApiPropertyOptional({
...
@Exclude()
export class GetDriverRaceTypeRecordsResponseDtoV3 {
  @Expose()
  @ApiProperty({
  ...
  constructor(partial: Partial<GetDriverRaceTypeRecordsResponseDtoV3>) {
    Object.assign(this, partial);
  }
}

@Exclude()
export class GetDriverRatingResponseDtoV3 {
  @Expose()
  @ApiProperty({
    description: 'Driver ID',
    type: 'number',
  ...
  @Transform(({ obj }) => (obj.photo ? `/api/v3/drivers/${obj.driver_id}/photo?d=${obj.updated_at}` : null))
  photo: boolean;
  ...
  @Transform(({ value }) => new GetDriverRaceTypeRecordsResponseDtoV3(value))
  rating: GetDriverRaceTypeRecordsResponseDtoV3;

  constructor(partial: Partial<GetDriverRatingResponseDtoV3>) {
    Object.assign(this, partial);
  }
}
