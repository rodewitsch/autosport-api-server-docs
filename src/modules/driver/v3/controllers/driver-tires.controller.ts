...
import { AddDriverTiresBodyDtoV3, DriverTiresResponseDtoV3 } from '../dto/driver-tires.dto';
...
export class DriverTiresControllerV3 {
  constructor() {}

  @Post()
  @ApiOperation({ summary: 'Add driver tires' })
  @ApiResponses({
    200: DriverTiresResponseDtoV3,
  ...
  async addDriverTires(
    ...
    @Body() body: AddDriverTiresBodyDtoV3,
  ) {}
