...
import {
  AddDriverDocumentsBodyDtoV3,
  DriverDocumentsResponseDtoV3,
  GetDriverDocumentsQueryDtoV3,
  UpdateDriverDocumentsBodyDtoV3,
...
export class DriverDocumentsControllerV3 {
  constructor() {}

  @Post()
  @ApiOperation({ summary: 'Add driver document' })
  @ApiResponses({
    200: DriverDocumentsResponseDtoV3,
  ...
  async addDriverDocument(
    ...
    @Body() body: AddDriverDocumentsBodyDtoV3,
  ) {}
  ...
  async updateDriverDocument(
    ...
    @Body() body: UpdateDriverDocumentsBodyDtoV3,
  ) {}
  ...
  async getDriverDocuments(
    @Session() profileData: ProfileData,
    @Param('driver_id') driver_id: string,
    @Query() query: GetDriverDocumentsQueryDtoV3,
  ) {}
