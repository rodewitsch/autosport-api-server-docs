...
export class GetDriverRecordsQueryDtoV2 {
  @ApiPropertyOptional({
...
@Exclude()
export class GetDriverTimeAttackRecordsResponseDtoV2 {
  @Expose()
  @ApiProperty({
  ...
  constructor(partial: Partial<GetDriverTimeAttackRecordsResponseDtoV2>) {
