...
import {
  AddDriverVehicleBodyDtoV2,
  DriverVehicleResponseDtoV2,
  UpdateDriverVehicleBodyDtoV2,
...
export class DriverVehicleControllerV2 {
  constructor() {}

  @Get()
  @ApiOperation({ summary: 'Get driver vehicles' })
  @ApiResponses({
    200: [DriverVehicleResponseDtoV2],
  ...
  async addDriverVehicle(
    ...
    @Body() body: AddDriverVehicleBodyDtoV2,
  ) {}
  ...
  async updateDriverVehicle(
    ...
    @Body() body: UpdateDriverVehicleBodyDtoV2,
  ) {}
